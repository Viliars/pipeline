...
model_urls = {
    ...
    'efficientnet_b7': 'https://www.dropbox.com/s/atxgtt2qcf9mnhn/efficientnet-b7-dcc49843.pth?dl=1',
}

params = {
    'efficientnet_b0': (1.0, 1.0, 224, 0.2),
    'efficientnet_b0_lite': (0.65, 1.0, 224, 0.2),  # ~0.5 GFLOPs version
...
@mlconfig.register
def efficientnet_b0_lite(pretrained=False, progress=True, **kwargs):
    return _efficientnet('efficientnet_b0_lite', pretrained, progress, **kwargs)
